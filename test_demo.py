...
def select_model(args, device):
    ...
    if model_id == 0:
        ...
        from models.team14_TAFNet_arch import RTAFNetLocal
        name, data_range = f"{model_id:14}_RTAFNet_baseline", 1.0
        model_path = os.path.join('model_zoo', 'team14_RTAFNet.pth')
        model = RTAFNetLocal()
